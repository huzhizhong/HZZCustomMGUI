...
#import "HZZTabBarViewController.h"

@interface AppDelegate ()
@property (strong, nonatomic) HZZTabBarViewController *rootTabBarViewController;
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    _rootTabBarViewController = [[HZZTabBarViewController alloc]init];
